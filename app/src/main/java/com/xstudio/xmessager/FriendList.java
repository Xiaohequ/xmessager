	...
	public void updateData(FriendInfo[] friends, FriendInfo[] unApprovedFriends)
	{
		...
		if (unApprovedFriends != null) 
		{
			...
			{					
				...
				Intent resultIntent = new Intent(this, UnApprovedFriendList.class);
				resultIntent.putExtra(FriendInfo.FRIEND_LIST, tmp);
				...
				stackBuilder.addParentStack(UnApprovedFriendList.class);
				...
				mNotificationManager.notify(R.string.new_friend_request_exist, mBuilder.build());
			}
			else
			{
