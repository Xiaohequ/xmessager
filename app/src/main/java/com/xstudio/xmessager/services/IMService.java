...
package com.xstudio.xmessager.services;
...
import com.xstudio.xmessager.Login;
import com.xstudio.xmessager.Messaging;
import com.xstudio.xmessager.R;
import com.xstudio.xmessager.UnApprovedFriendList;
import com.xstudio.xmessager.communication.SocketOperator;
import com.xstudio.xmessager.interfaces.IAppManager;
import com.xstudio.xmessager.interfaces.ISocketOperator;
import com.xstudio.xmessager.interfaces.IUpdateData;
import com.xstudio.xmessager.tools.FriendController;
import com.xstudio.xmessager.tools.XMLHandler;
...
// * in the same process as the application.  The {@link android.net.LocalSocket}
// * and {@link android.net.LocalServerSocket} classes show how to interact with the
// * service.
 *
...
//     				((msg.length() < 5) ? msg : msg.substring(0, 5)+ "...");
		...
		resultIntent.putExtra(FriendInfo.USERNAME, username);
		resultIntent.putExtra(FriendInfo.MESSAGE, msg);
		...
		mNotificationManager.notify((username+msg).hashCode(), mBuilder.build());
