package com.xstudio.xmessager.communication;
...
public class SocketOperator implements ISocketOperator {
	private static final String TAG = SocketOperator.class.getSimpleName();
	...
	//			PrintWriter out = new PrintWriter(clientSocket.getOutputStream(), true);
				...
				Log.e(TAG, "ReceiveConnection.run: when receiving connection ");
			}			
		}	
	}
	...
	private Socket getSocket(InetAddress addr, int portNo) 
	{
		...
		if (sockets.containsKey(addr) == true) 
		{
			...
			{			
				...
				try {
					...
					Log.e(TAG, "getSocket: when closing and removing");
				}				
			}
		}
		else  
		{
			try {
				...
				Log.e(TAG, "getSocket: when creating");
			}					
		}
		return socket;		
	}
